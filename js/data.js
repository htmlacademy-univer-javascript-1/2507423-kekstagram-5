...
const createPictureData = function () {
  ...
  return {
    ...
    comments: Array.from({length: getRandomInteger(0, PHOTO_COMMENTS_COUNT)}, createCommentData),
  };
};

const createPhotoGallery = () => Array.from({length: PHOTO_COUNT}, createPictureData);
